...
public class SearchArtistTest extends AbstractTest {
    ...
    @Test(dataProvider = "Valid artist names", description = "testing of searching with valid request", priority = 2)
    ...
    @Test(dataProvider = "Invalid artist names", description = "testing of searching with invalid request", priority = 2)
